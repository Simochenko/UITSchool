...
public class TransportShow {
    ...
    public static void consolIO(PassengerTrain passengerTrain) {
        ...
        boolean end = false;
        while (!end) {
            System.out.println("Сортировка по  уровню   комфортности  нажмите   : 1 ");
            System.out.println("Найти вагоны в заданном диапазоне параметров числа  пассажиров нажмите  : 2 ");
            try {
